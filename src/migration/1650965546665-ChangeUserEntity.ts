...
export class ChangeUserEntity1650965546665 implements MigrationInterface {
    name = 'ChangeUserEntity1650965546665'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "confirm_key" TO "confirmKey"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" RENAME COLUMN "confirmKey" TO "confirm_key"`);
    }
